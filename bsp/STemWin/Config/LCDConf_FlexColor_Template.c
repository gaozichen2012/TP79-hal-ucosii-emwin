...
void LCD_X_Config(void) {
  ...
  pDevice = GUI_DEVICE_CreateAndLink(GUIDRV_FLEXCOLOR, GUICC_M565, 0, 0);//GUICC_565 红 GUICC_M565蓝
  //
  ...
  //GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, GUIDRV_FLEXCOLOR_F66708, GUIDRV_FLEXCOLOR_M16C0B16);
	...
	/*GUIDRV_FLEXCOLOR_F66709表示选择芯片ST7735，GUIDRV_FLEXCOLOR_M16C0B8表示选择8位数据总线*/
